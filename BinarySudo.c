...
/*************************************************************
函数名称:UniqueCombine
函数功能:每次运行能生成一个C(m,n)的不重复组合
输入的参数:初始化后的组合标记数组，存放数据的target数组以及待压入的data数组
返回值:本次运行是否产生了一种新的组合方式，1为是，0为否
**************************************************************/
